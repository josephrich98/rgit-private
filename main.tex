...
(clear-cell renal cell carcinoma)~\citep{ricketts2018tcgakirc} --- to demonstrate how the recoverability
...
\emph{RadImageNet}~\citep{mei2022radimagenet} 2D backbone applied tile-wise within the tumour mask
...
pipeline using PyRadiomics~\citep{vangriethuysen2017pyradiomics,aerts2014radiomics}
shape/texture features is supported for
ablations.)
...
in the range $0.65$--$0.80$ at cohort sizes $n \sim 100$--$300$
\citep{jamshidi2015ccrcc,udayakumar2024radiogenomic,gevaert2012nsclc,bi2019ai,hosny2018ai} imply
