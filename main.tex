...
(Fig.~\ref{fig:nsclc-spectrum}) is of similar magnitude but, unlike KIRC's, does
...
\begin{figure}[h]
\centering
\includegraphics[width=0.75\linewidth]{\adnifig{deconfound_comparison.pdf}}
\caption{Demographic deconfounding on ADNI. Honest cross-validated
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{\adnifig{downsample_recoverability.pdf}}
\caption{Data-requirement sweep on ADNI at fixed working dimension
...
$p\approx 0.005$) --- the most defensible positive of the three. In NSCLC, an
