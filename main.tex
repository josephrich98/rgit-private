...
\usepackage{xcolor}
\usepackage[colorlinks=true, linkcolor=lightgray, citecolor=lightgray]{hyperref}
\usepackage{graphicx}
\usepackage{booktabs}
...
\author{
Joseph Rich$^{1,3}$\\[0.5em] \qquad Lior Pachter$^{1,2}$\thanks{Address correspondence to lpachter@caltech.edu.}
\small $^1$Division of Biology and Biological Engineering, California Institute of Technology\\
\small $^2$Department of Computing and Mathematical Sciences, California Institute of Technology\\
\small $^3$Keck School of Medicine, University of Southern California
}
\date{}
